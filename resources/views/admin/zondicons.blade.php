...
@section('content')
    ...
    <section class="auto-tables p-6 md:p-8 -mt-16">
        <article class="entypo w-full px-6 md:px-8 py-8 md:py-12 rounded-lg bg-white shadow-lg">
            <h2 class="text-2xl font-hairline font-sans mb-6">Zondicons</h2>
		
			<div class="icons p-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
				@foreach (Storage::files('public/zondicons') as $path)
					<div class="w-full py-12 border border-gray-200 rounded-lg bg-white shadow-lg flex flex-col items-center justify-center">
