<tr class="border-b border-gray-200 text-center align-middle hover:bg-gray-200">
    <td class="{{ $width }} px-4 py-2">{{ $id }}</td>
    <td class="{{ $width }} px-4 py-2">{{ $person['name'] }}</td>
    <td class="{{ $width }} px-4 py-2">{{ $person['email'] }}</td>
    <td class="{{ $width }} px-4 py-2">{{ $person['role'] }}</td>
    <td class="{{ $width }} px-4 py-2">{{ $person['joined'] }}</td>
